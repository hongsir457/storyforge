...
Run: `cd /Users/pollochen/MyProjects/autovideo/.worktrees/feature/episode-cost-estimation && uv run alembic revision --autogenerate -m "add segment_id to api_calls"`
