...
export default {
  ...
  'apply_openrouter_preset': 'Use OpenRouter preset',
  ...
  'anthropic_key_required_desc': 'An Anthropic API key or OpenRouter token is required for the agent to function',
  'env_anthropic_api_key': 'Maps to environment variable ANTHROPIC_API_KEY',
  'env_anthropic_auth_token': 'Maps to ANTHROPIC_AUTH_TOKEN for OpenRouter-compatible bearer auth',
  'clear_saved_anthropic_key': 'Clear saved Anthropic API Key',
  'clear_saved_openrouter_key': 'Clear saved OpenRouter API Key',
  ...
  'openrouter_auth_token_hint': 'Use this bearer token with OpenRouter. Recommended base URL: https://openrouter.ai/api',
  ...
  'visual_systems_title': 'Visual Systems',
  'visual_systems_desc': 'Turn the homepage promises into project controls that are visible in the studio and fed into storyboard/video generation.',
  'save_visual_systems': 'Save Visual Systems',
  'dynamic_visual_capture_title': 'Dynamic Visual Capture',
  'dynamic_visual_capture_desc': 'Control how the current shot inherits continuity from the running sequence before each storyboard is generated.',
  'capture_reference_mode': 'Reference priority',
  'capture_mode_balanced': 'Balanced',
  'capture_mode_composition': 'Composition',
  'capture_mode_tone': 'Tone',
  'capture_use_previous_storyboard': 'Use previous storyboard as the primary continuity reference',
  'capture_continuity_notes': 'Continuity notes',
  'capture_continuity_placeholder': 'e.g. keep the corridor spill light, shoulder line, and lens distance stable across this run of shots.',
  'tone_console_title': 'Tone Console',
  'tone_console_desc': 'Shape palette bias, warmth, saturation, and contrast at the project level instead of hoping each prompt lands in the same neighborhood.',
  'tone_palette_mode': 'Palette mode',
  'tone_palette_story_led': 'Story-led',
  'tone_palette_editorial_warm': 'Editorial Warm',
  'tone_palette_cool_cinematic': 'Cool Cinematic',
  'tone_palette_noir_contrast': 'Noir Contrast',
  'tone_palette_dream_wash': 'Dream Wash',
  'tone_saturation': 'Saturation',
  'tone_warmth': 'Warmth',
  'tone_contrast': 'Contrast',
  'tone_notes': 'Tone notes',
  'tone_notes_placeholder': 'e.g. keep blacks clean, skin tones restrained, and practical lights slightly cyan.',
  'realtime_storyboard_sync_title': 'Realtime Storyboard Sync',
  'realtime_storyboard_sync_desc': 'Watch the live workspace stream, queue health, and recent generation events while defining how story beats and camera language stay locked through export.',
  'sync_stream_label': 'Workspace Stream',
  'sync_queue_label': 'Task Queue',
  'sync_connected': 'Connected',
  'sync_disconnected': 'Disconnected',
  'sync_last_event': 'Last event:',
  'sync_last_event_waiting': 'Waiting for the first sync batch',
  'sync_recent_actions': 'Recent actions',
  'sync_no_recent_actions': 'No recent actions yet',
  'sync_story_beats': 'Keep story beats synchronized with the visual sequence',
  'sync_camera_language': 'Keep camera language aligned across storyboard and final video',
  'sync_export_notes': 'Export notes',
  'sync_export_placeholder': 'e.g. keep the push-in cadence from boards 04-07 and avoid introducing a wider lens on export.',
  'sync_action_snapshot': 'Snapshot received',
  'sync_action_storyboard_ready': 'Storyboard ready',
  'sync_action_video_ready': 'Video ready',
  'sync_action_grid_ready': 'Grid ready',
  'sync_action_updated': 'Asset updated',
  'sync_action_created': 'Created',
