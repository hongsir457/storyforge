...
export default {
  ...
  'apply_openrouter_preset': '应用 OpenRouter 预设',
  ...
  'agent_config_saved': 'Frametale 智能体配置已保存',
  'field_cleared': '已清除',
  'api_key_mgmt': 'API 密钥管理',
  'api_key_usage_desc': '用于从外部工具（如 OpenClaw 🦞）访问 Frametale 项目。',
  ...
  'anthropic_key_required_desc': 'Anthropic API 密钥或 OpenRouter Token 是智能体运行的必要条件',
  'env_anthropic_api_key': '对应环境变量 ANTHROPIC_API_KEY',
  'env_anthropic_auth_token': '对应 ANTHROPIC_AUTH_TOKEN，用于 OpenRouter Bearer 认证',
  'clear_saved_anthropic_key': '清除已保存的 Anthropic API Key',
  'clear_saved_openrouter_key': '清除已保存的 OpenRouter API Key',
  'clear_saved': '清除已保存',
  'env_anthropic_base_url': '对应 ANTHROPIC_BASE_URL，留空使用官方默认地址',
  'clear_saved_base_url': '清除已保存的 Anthropic Base URL',
  'openrouter_auth_token_hint': '使用 OpenRouter 时建议填写这里，并将 API 代理地址设为 https://openrouter.ai/api',
  'model_config': '模型配置',
  ...
  // config-status-store
  'agent_api_key_not_configured': 'Frametale 智能体认证未配置（需 Anthropic API Key 或 OpenRouter Token）',
  ...
  'visual_systems_title': '视觉系统面板',
  'visual_systems_desc': '把首页上的三块卖点落成工作区里的真实控制面板，并把配置直接送进分镜和视频生成链路。',
  'save_visual_systems': '保存视觉系统',
  'dynamic_visual_capture_title': '动态视觉捕捉',
  'dynamic_visual_capture_desc': '控制当前镜头在生成分镜前，如何继承连续镜头的构图、机位和氛围信息。',
  'capture_reference_mode': '参考优先级',
  'capture_mode_balanced': '均衡',
  'capture_mode_composition': '构图优先',
  'capture_mode_tone': '色调优先',
  'capture_use_previous_storyboard': '使用上一张分镜图作为主要连续性参考',
  'capture_continuity_notes': '连续性备注',
  'capture_continuity_placeholder': '例如：保持走廊侧逆光、人物肩线方向和镜头距离连续，不要在这一段突然换成更广的视角。',
  'tone_console_title': '色调控制台',
  'tone_console_desc': '在项目级别统一调色方向、冷暖、饱和度和反差，而不是把希望寄托在每一条 prompt 都刚好命中同一种质感。',
  'tone_palette_mode': '调色模式',
  'tone_palette_story_led': '故事驱动',
  'tone_palette_editorial_warm': '暖调出版感',
  'tone_palette_cool_cinematic': '冷调电影感',
  'tone_palette_noir_contrast': '高反差黑色电影',
  'tone_palette_dream_wash': '梦感柔焦',
  'tone_saturation': '饱和度',
  'tone_warmth': '冷暖倾向',
  'tone_contrast': '反差',
  'tone_notes': '色调备注',
  'tone_notes_placeholder': '例如：保持黑位干净、肤色克制，实景灯偏冷青，不要泛出明显橙色污染。',
  'realtime_storyboard_sync_title': '实时分镜同步',
  'realtime_storyboard_sync_desc': '查看工作区实时事件流、任务队列和最近生成结果，同时锁定故事节拍与镜头语言在最终导出前保持一致。',
  'sync_stream_label': '工作区事件流',
  'sync_queue_label': '任务队列',
  'sync_connected': '已连接',
  'sync_disconnected': '未连接',
  'sync_last_event': '最近事件：',
  'sync_last_event_waiting': '等待第一批同步事件',
  'sync_recent_actions': '最近动作',
  'sync_no_recent_actions': '暂时没有新的同步动作',
  'sync_story_beats': '让故事节拍和画面序列保持同步',
  'sync_camera_language': '让镜头语言在分镜和最终视频之间保持一致',
  'sync_export_notes': '导出备注',
  'sync_export_placeholder': '例如：保留 04-07 号分镜的推镜节奏，导出视频时不要突然切成更广的镜头语言。',
  'sync_action_snapshot': '收到快照',
  'sync_action_storyboard_ready': '分镜已完成',
  'sync_action_video_ready': '视频已完成',
  'sync_action_grid_ready': '宫格已完成',
  'sync_action_updated': '资源已更新',
  'sync_action_created': '新建完成',
