...
export function NotFoundPage() {
  ...
  return (
    <div className="storyforge-public-shell flex min-h-screen items-center justify-center px-6 py-12">
      <div className="storyforge-form-card w-full max-w-2xl rounded-[2.2rem] p-10 text-center">
        ...
        <p className="mt-8 text-[5.5rem] font-semibold leading-none tracking-[-0.08em] text-[var(--sf-text)]" style={{ fontFamily: "var(--font-display)" }}>
          404
        </p>
