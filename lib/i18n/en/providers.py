...
MESSAGES: dict[str, str] = {
    ...
    "provider_name_openrouter": "OpenRouter",
    ...
    "provider_desc_openrouter": "OpenRouter aggregates Claude, GPT, Gemini and other text models behind a single OpenAI-compatible API.",
}
