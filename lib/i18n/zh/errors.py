MESSAGES = {
    "project_not_found": "项目 '{name}' 不存在或尚未初始化",
    "scope_invalid": "scope 必须是 full 或 current",
    ...
    "content_or_file_required": "请提供 content 或 file 其中之一",
    "one_of_content_or_file": "content 和 file 不能同时提供，请二选一",
    "unsupported_file_type": "仅支持 .txt / .md 文件，收到: {name}",
    "file_too_large": "文件大小超出限制（最大约 {max_chars} 字符）",
    "invalid_encoding": "文件编码错误，请使用 UTF-8 编码的文本文档",
    ...
    "password_reset_code_sent": "如果账户存在，重置密码验证码已发送",
    ...
    "interface_offline": "该接口已下线，请使用推荐接口",
    ...
    "project_id_not_editable": "content_mode 在项目创建后不可修改",
